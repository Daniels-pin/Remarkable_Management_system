...
from app.routers import (
    ...
    barbershop_ledger,
    barbershop_team_advances,
    barbershop_personal_consumption,
    dashboard,
    finance,
    health,
...
api_v1.include_router(barbershop_team_advances.router)
api_v1.include_router(barbershop_personal_consumption.router)
